...
import CodeComponent from './components/CodeComponent'; // Add this import
...
const App = () => {
  ...
  const [chat, setChat] = useState<chatData | null>(null) // Set initial state to null
  ...
  return (
    <>
      ...
      <CodeComponent /> {/* Add this component */}
      {/* main section ends */}
      <Benefits />
