...
function Contributors() {
  ...
  function renderContributors(contributors: Contributor[]) {
    return contributors.map((contributor) => {
      ...
      if (
        ...
        return (
          <div
            className={`bg-[#4285f430] border border-[#4285f430] team-member-card rounded-[10%] p-[20px] flex gap-[10px] mt-0 flex-col items-center [transition:0.3s] scale-[0.95] hover:scale-[1] hover:-translate-y-2 hover:shadow-lg dark:bg-[#1a1a1a] dark:border-[#2d2d2d] hover:shadow-zinc-900 dark:hover:shadow-slate-400`}
          ...
          >
            ...
            >
              ...
              <div className="member-info-div text-center w-full">
                <h2 className="mt-[10px] mx-[0] mb-[5px] text-[1.2em] font-semibold dark:text-white">
                  {name}
                </h2>
              ...
              <div className="splide__slide" id="c2">
                <div>
                  ...
                  >
                    ...
                    <p
                      id="name1"
                      className={`text-black relative bottom-[25px] font-poppins text-[30px] font-bold dark:text-white`}
                    >
                      {contributors[0].name || contributors[0].login}
                    </p>
                    <p
                      id="co1"
                      className={`text-[#00000094] relative bottom-[25px] font-poppins text-[30px] font-medium max-[845px]:font-[25px] max-[845px]:font-[500] max-[845px]:mb-[10px] dark:text-gray-500`}
                    >
              ...
              <div className="splide__slide top-contributor" id="c1">
                <div>
                  ...
                  >
                    ...
                    >
                      <img
                        className="max-w-none relative left-[50px] top-0 h-[160px] w-[160px] rotate-[20deg] max-[845px]:w-[250px] max-[845px]:h-[250px] max-[845px]:top-[-60px]"
                        src="src\assets\crown.png"
                      />
                    </div>
                    <p
                      id="name2"
                      className={`text-black relative bottom-[35px] font-poppins text-[20px] font-bold max-[845px]:font-[30px] max-[845px]:font-[700] dark:text-white`}
                    >
                      {contributors[1].name || contributors[1].login}
                    </p>
                    <p
                      id="co2"
                      className={`text-[#00000094] relative bottom-[25px] font-poppins text-[20px] font-medium max-[845px]:font-[25px] max-[845px]:font-[500] max-[845px]:mb-[10px] dark:text-gray-500`}
                    >
              ...
              <div className="splide__slide" id="c3">
                <div>
                  ...
                  >
                    ...
                    <p
                      id="name3"
                      className={`text-black relative bottom-[35px] font-poppins text-[20px] font-bold text-black max-[845px]:font-[30px] max-[845px]:font-[700] dark:text-white`}
                    >
      ...
      return (
        <div className="top-contributor flex justify-center items-end gap-[40px]">
          ...
          >
            ...
            <p
              id="name2"
              className={`text-black relative bottom-[35px] font-poppins text-[20px] font-bold dark:text-white`}
            >
              {contributors[1].name || contributors[1].login}
            </p>
            <p
              id="co2"
              className={`text-[#00000094] relative bottom-[25px] font-poppins text-[20px] font-medium dark:text-gray-500`}
            >
              contributions {contributors[1].contributions}
            </p>
          </div>
          ...
          >
            ...
            <p
              id="co1"
              className={`text-[#00000094] relative bottom-[25px] font-poppins text-[30px] font-medium dark:text-gray-500`}
            >
              contributions {contributors[0].contributions}
            </p>
          </div>
  ...
  return (
    <div className="m-0 font-arial min-h-screen w-full bg-white dark:bg-[#121212]">
      <div
        id="ourteam"
        className="flex justify-center items-center font-bold text-[38px] pt-[160px] pb-[20px] text-center max-md:text-[32px] max-sm:text-[28px] max-sm:pt-[120px] max-sm:pb-[40px] max-sm:ml-[40px] text-black dark:text-white"
      >
        Maintainers
      </div>
      ...
      <div id="team-grid" className="flex justify-center mt-0">
        {/* Team Member */}
        <div
          className={`bg-[#4285f430] team-member flex items-center border border-[#4285f430] rounded-[20px] p-[20px] bg-center bg-cover bg-no-repeat transition-all duration-500 pr-0 hover:scale-[1.03] max-md:flex-col max-md:p-[15px] max-md:ml-[50px] max-sm:ml-[20px]`}
        >
          <div
            className={`bg-[#2b6cb060] border-[#3498db] card1 pt-8 rounded-[2rem] flex flex-col items-center relative w-[85%] h-full max-md:w-full max-md:pt-6 max-sm:pt-4 dark:bg-[#333333]`}
          >
            <div className="margin h-[90%] flex flex-col justify-center items-center">
              <div className="image-div flex-none flex justify-center items-center">
                <img
                  className="rounded-[50%] w-[28%] max-md:w-[35%] max-sm:w-[45%]"
                  src={`https://github.com/harmeetsingh11.png`}
                  alt="Harmeet Singh"
                />
              </div>
              <div className="info-div text-center mt-[5px]">
                <h2 className="mt-[10px] text-[1.5em] font-bold mb-2 font-arial max-md:text-[1.3em] max-sm:text-[1.1em] text-black dark:text-white">
                  Harmeet Singh
                </h2>
                <p className="mt-[5px] block text-[16px] text-[#000000] font-arial max-md:text-[14px] max-sm:text-[12px] dark:text-[#ddd]">
          ...
          <div className="social-links w-[16%] p-[12px] pl-[12px] pr-[12px] max-md:w-full max-md:flex max-md:justify-center max-md:mt-2 max-sm:mt-0 max-sm:gap-6">
            <div className="social-links-items [transition:0.3s_ease-in-out] flex justify-center flex-col items-center pt-[25px] rounded-[10px] w-full mx-[0rem] my-[0.6rem] hover:bg-[#2b6cb05c] dark:hover:bg-[#444444] max-md:mx-[1rem] max-md:w-auto max-sm:mx-[0.5rem]">
              ...
              >
                <FontAwesomeIcon
                  icon={faHeart}
                  className={`social-icon scale-[2.5] max-md:scale-[2] max-sm:scale-[1.5] dark:text-white`}
                />
              </a>
              <p
                className={`text-[#000000] text-[14px] mt-[10px] font-arial cursor-pointer max-md:text-[12px] max-sm:text-[10px] dark:text-white`}
              >
                Sponsor
              </p>
            </div>
      ...
      <div className="teams-container text-center h-[95vh] flex flex-col justify-center items-center max-[845px]:h-auto max-[845px]:m-[50px 0px] dark:bg-[#121212] dark:text-white">
        <h1 className="contri text-[38px] mt-[50px] font-bold max-md:text-[32px] max-sm:text-[28px] max-md:mt-[60px] max-md:mb-[40px] max-sm:ml-[40px]">
          Top 3 Contributors
        </h1>
        <div
          id="contributors"
          className="mt-[110px] flex justify-center items-end gap-[40px] max-[845px]:mt-0 max-[845px]:overflow-x-hidden max-[845px]:w-[100%] max-[845px]:h-[450px]"
        >
      ...
      <div
        id="team-grid1"
        className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-[10px] ml-8 mr-8 p-[30px] max-md:ml-[50px] max-sm:ml-10 max-[375px]:ml-0 dark:bg-[#121212]"
      >
      ...
      <div className="load p-5 flex justify-center items-center">
        ...
        >
          Load More
          <svg
            className="w-3.5 h-3.5 ms-2 rtl:rotate-180 transform group-hover:rotate-90 transition-transform duration-300"
            aria-hidden="true"
