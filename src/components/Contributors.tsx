  ...
  function renderContributors(contributors: Contributor[]) {
    return contributors.map((contributor) => {
      ...
      if (
        ...
        return (
          <div
            className={`bg-[#4285f430] border border-[#4285f430] team-member-card rounded-[10%] p-[20px] flex gap-[10px] mt-0 flex-col items-center [transition:0.3s] scale-[0.95] hover:scale-[1] hover:-translate-y-2 hover:shadow-lg dark:bg-[#1a1a1a] dark:border-[#2d2d2d] dark:hover:shadow-gray-400`}
