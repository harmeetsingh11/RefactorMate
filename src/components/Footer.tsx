...
const Footer = () => {
  return (
<footer className="bg-white dark:bg-gray-700" id="footer">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between w-full max-w-screen-xl">
        ...
        <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              ...
              <a href="https://linkedin.com/in/harmeetsingh113" target="_blank" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
